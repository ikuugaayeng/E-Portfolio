...
## [LiDAR data processing and Tools]{#section1 .highlight-blue}
...
:::::::: col-md-5
![LiDAR point cloud](images/lidar.jpg){width="47%"} [Figure 3: Types of LiDAR from Salas (2021).]{.figure-caption}
...
::::: {.grid .gap-2}
::: g-col-6
![Tree Detection](images/tree-detection.gif){width="70%"} [Figure 1: Tree detection using LiDAR.]{.figure-caption}
:::

::: g-col-6
![Individual Tree Detection](images/individual-tree-detection.gif){width="70%"} [Figure 2: Individual tree identification workflow using LiDAR.]{.figure-caption}
:::
:::::
